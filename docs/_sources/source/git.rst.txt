...
.. tip::
   ...
   If you don't want to read what follows. Here is the minimal, all commands are issued from the powershell or terminal application.
    ...
    1. Fork the SimCenterProgrammingBootcamp2025 repo in your browser.
    ...
    2. Clone a Copy of YOUR Fork to local computer. In PowerShell (Winddows) or in terminal (MacOS), cd to a directory you want to place the repo and then type:
          ...
          .. code::
                ...
                git clone https://github.com/YOUR_NAME/SimCenterBootcamp2025.git
       
    3. Change into the local `SimCenterBootcamp2025` folder
    ...
    1. Save the changes you want to KEEP to your local repo and your forked copy (execute inside the `SimCenterBootcamp2025` folder):
